...
# ingress-nodefw.io/ingress-node-firewall-bundle:$VERSION and ingress-nodefw.io/ingress-node-firewall-catalog:$VERSION.
IMAGE_TAG_BASE ?= ingress-nodefw.io/ingress-node-firewall
